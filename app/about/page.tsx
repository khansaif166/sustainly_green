      ...
      <main className="max-w-full mx-auto px-6 py-16 space-y-16">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm md:text-base text-white">
              Building a global marketplace for sustainable products,
              responsible businesses, and conscious consumers.
            </p>
          </div>
        </section>
        ...
        <section className="grid md:grid-cols-2 gap-10 items-center">
          <div className="space-y-4">
            ...
            <p className="text-sm text-[var(--color-text-secondary)] leading-relaxed">
              Sustainly Green is a sustainability-focused marketplace designed
              to connect verified eco-friendly brands with buyers who care about
              the planet. We make it easy for individuals and businesses to
              discover, compare, and source sustainable products and services
        ...
        <section className="space-y-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <ValueCard
              icon={
                <Leaf className="h-6 w-6 text-[var(--color-primary-green)]" />
              }
            ...
            <ValueCard
              icon={
                <BadgeCheck className="h-6 w-6 text-[var(--color-ocean-blue)]" />
              }
            ...
            <ValueCard
              icon={
                <Eye className="h-6 w-6 text-[var(--color-solar-yellow)]" />
              }
              title="Transparency"
            ...
            <ValueCard
              icon={
                <Globe2 className="h-6 w-6 text-[var(--color-primary-green)]" />
              }
              title="Global Impact"
